...
describe("loadCode()", () => {
  test("correctly decodes a loadout code", () => {
    const army = loadCode(loadoutCode1);
  ...
  test("correctly decodes a loadout code with Priestess", () => {
    const army = loadCode(loadoutCodeWithPriestess);
  ...
  test("correctly decodes a loadout code with a mini having no talent selected", () => {
    const army = loadCode(loadoutCodeWithoutTalent);
  ...
  test("correctly decodes a loadout code with Arthas", () => {
    const army = loadCode(loadoutCodeWithArthas);
